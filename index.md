...
Интеграционный (связный) тест обеспечивает проверку взаимодействия между модулями или даже глобальнее между сервисами приложения (например что все сервсисы одинаково интерпретируют пользовательскую сессию). Куда более специализированные, т.к. пишущий тест должен представлять взаимосвязи компонентов.
